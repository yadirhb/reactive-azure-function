...
import { HttpRequestObservable, RxHttpController } from "@shared/azure/functions/rxjs";
...
@Service()
export class MainController implements RxHttpController {
    ...
    onRequest(stream$: HttpRequestObservable): Observable<HttpResponseInit> {
        return stream$.pipe(
